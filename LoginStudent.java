...
co=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:ORCL", "system", "Tashmeet05");
...
ps= co.prepareStatement("select count(*) from
login_test where user_id=? and user_name=? and password=?");
...
if(count== 0)
{
JOptionPane.showMessageDialog(f3, "Invalid
